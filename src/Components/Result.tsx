    ...
    <>
      ...
      <div className='d-grid mt-2'>
        <button
          type='button'
          disabled={!showStats}
          className='btn py-3 btn-success reload'
      ...
      <div className='speed-meter'>
        ...
        <div className='d-flex align-items-center text-white meter-gauge'>
          ...
          <span className={`col average${wpm > 21 && wpm < 41 ? ' border' : ''}`}>
            20 - 40 Average
          </span>
          <span className={`col fast${wpm > 41 && wpm < 61 ? ' border' : ''}`}>40 - 60 Fast</span>
          <span className={`col professional${wpm > 61 && wpm < 81 ? ' border' : ''}`}>
            60 - 80 Professional
          </span>
          <span className={`col top${wpm > 81 ? ' border' : ''}`}>80 - 100+ Top</span>
        </div>
        <div className='result-into mt-5'>
          <h6>Tip!</h6>
          <ul>
            <li>
